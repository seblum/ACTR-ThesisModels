proc make_buffer_viewer {} {
  ...
  if {$model == "nil"} {
    ...
    bind $list_box <<ListboxSelect>> "select_buffer_viewer $list_box $text_box $model"
    ...
    set_update_script $win "update_buffers_list $list_box $text_box $model"
...
proc update_buffers_list {list text_box model} {
  ...
  select_buffer_viewer $list $text_box $model
}

proc select_buffer_viewer {list_box text_box model} {
...
button [control_panel_name].buffers -command {make_buffer_viewer} \
