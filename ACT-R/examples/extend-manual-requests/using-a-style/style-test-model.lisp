...
CG-USER(114): (run 1)
     ...
     0.400   NONE                   #<Interpreted Closure (INTERNAL (METHOD QUEUE-OUTPUT-EVENTS (MOTOR-MODULE NEW-ACTION)))> 1 2 0.15 0.3
...
finishing after 0.3 seconds
     ...
     0.550   MOTOR                  PREPARATION-COMPLETE
     0.550   PROCEDURAL             CONFLICT-RESOLUTION
     0.600   MOTOR                  INITIATION-COMPLETE
     0.600   PROCEDURAL             CONFLICT-RESOLUTION
     0.750   NONE                   #<Interpreted Closure (INTERNAL (METHOD QUEUE-OUTPUT-EVENTS (MOTOR-MODULE NEW-ACTION)))> 1 2 0.0 0.3
Features are 1 and 2
0.0 seconds spent in preparation
finishing after 0.3 seconds
     0.750   PROCEDURAL             CONFLICT-RESOLUTION
     0.850   MOTOR                  FINISH-MOVEMENT
     ...
     0.900   MOTOR                  PREPARATION-COMPLETE
     0.900   PROCEDURAL             CONFLICT-RESOLUTION
     0.950   MOTOR                  INITIATION-COMPLETE
