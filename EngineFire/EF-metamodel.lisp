...
==>
  ...
  =goal>
    state               free
!eval! ("simulate-focus-middle" "start")
  )
...
!eval! ("state-anticipation-not-correct" "failed" 0 0 0 0) 
  )

(spp simulate-left-submodel :u 20)
(spp simulate-middle-submodel :u 20)
(spp simulate-right-submodel :u 20)
(spp simulate-left-break :u 5)
...
(spp match-middle :reward 20)
(spp match-right :reward 20)

(spp not-match-left :reward 0)
(spp not-match-middle :reward 0)
...
(p simulate-middle-submodel-action
  =goal>
    state               sim-sub-action-middle
  =imaginal>
==>
  ...
  =goal>
    state               actiontimecalc
!eval! ("simulate-action-middle" "start")
  )
