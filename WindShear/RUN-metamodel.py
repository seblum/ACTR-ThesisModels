...
# LOAD ACT-R MODELS
def loadmodels():
    actr.load_act_r_model(directory_path_lisp + ";WS-metamodel.lisp")
    actr.load_act_r_model(directory_path_lisp + ";WS-submodel-left.lisp")
    actr.load_act_r_model(directory_path_lisp + ";WS-submodel-right.lisp")
