...
!eval! ("state-anticipation-not-correct" "failed-2" 0 0 0 0) 
  )
...
==>
  ...
  =goal>
    state               free
    action              =actionnumber
!eval! ("simulate-submodel" "left" =actionnumber)
  )
...
==>
  ...
  =goal>
    state               free
    action              =actionnumber
!eval! ("simulate-submodel" "middle" =actionnumber)
  )
...
==>
  ...
  =goal>
    state               free
    action              =actionnumber
!eval! ("simulate-submodel" "right" =actionnumber)
  )
...
(P match-focus
  ...
  =goal>
    ...
    action              1
  =imaginal>
!eval! ("state-submodel-correct" "start" =result)
  )
...
==>
  ...
  =goal>
    ...
    action              2
    keepinmind          =ticktime
 !eval! ("print-ticktime" =ticks)
 !eval! ("save-keepinmind" =ticktime 2)
...
==>
  ...
  =goal>
    state               simulate-submodel
    action              2
 !eval! ("action-one-correct" =ticks =lowertime =uppertime)
  )
...
==>
  ...
  =goal>
    ...
    action              1
    keepinmind          =ticks
!eval! ("action-count" 1 1 =ticks =uppertime =lowertime)
  )
...
==>
  ...
  =goal>
    ...
    keepinmind          =ticktime
!eval! ("print-ticktime" =ticks)   
!eval! ("action-count" 1 1 =ticktime =uppertime =lowertime)
  )
...
==>
  ...
  =goal>
    ...
    action              2
    keepinmind          =ticks
!eval! ("action-count" 2 1 =ticks =uppertime =lowertime)
  )
...
==>
  ...
  =goal>
    ...
    keepinmind          =ticktime
!eval! ("print-ticktime" =ticks)   
!eval! ("action-count" 2 1 =ticktime =uppertime =lowertime)
  )
...
==>
  ...
  =goal>
    state               back-to-monitoring
    keepinmind          =ticktime
!eval! ("print-keepinmind" =ticktime)
!eval! ("save-keepinmind" =ticktime 2)
!eval! ("state-anticipation-correct" "successful-2" =ticks =uppertime =lowertime)
  )
...
==>
  ...
  =goal>
    state               simulate-submodel
    action              2
!eval! ("state-anticipation-not-correct" "failed-1" =ticks =uppertime =lowertime 1)
  )
...
!eval! ("print-keepinmind" =ticktime)
!eval! ("save-keepinmind" =ticktime 2)
!eval! ("state-anticipation-not-correct" "failed-2" =ticks =uppertime =lowertime =action)
  )
